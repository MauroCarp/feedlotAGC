      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="cantCabezas" style="height:230px;width:auto;"></canvas>
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="cantCabezasSexo" style="height:230px;width:auto;"></canvas>
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="precioCantidaConsignatario" style="height:230px;width:auto;"></canvas>
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="cantConsignatario" style="height:230px;width:auto;"></canvas>
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="cantConsignatarioSexo" style="height:230px;width:auto;"></canvas>
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="chart">
              ...
              <canvas id="cantProveedor" style="height:230px;width:auto;"></canvas>
