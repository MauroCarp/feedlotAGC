    ...
    <div class="col-md-4">
        ...
        <div class="box box-success">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Precio Kilo de MS - Promedio Anual:&nbsp;&nbsp;<span id="precioKgMSAnual<?php echo $i + 1;?>" style="font-weight:bold"></span></h3>
            ...
            <div class="box-body">
                ...
                <div class="chart">
                    ...
                    <canvas id="graficoPrecioKgMS<?php echo $i + 1;?>"></canvas>
